 ...
 *
 *    Keep the ElementsHydrexiumMod object in this class and all calls to this object
...
public class HydrexiumMod {
	...
	public static final String VERSION = "[Préalpha 2] {1.1.3.1}";
	...
	@Mod.Instance(MODID)
	public static HydrexiumMod instance;
	public ElementsHydrexiumMod elements = new ElementsHydrexiumMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsHydrexiumMod.GuiHandler());
