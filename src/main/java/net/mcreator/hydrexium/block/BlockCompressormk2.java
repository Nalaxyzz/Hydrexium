...
public class BlockCompressormk2 extends ElementsHydrexiumMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "hydrexium:tileentitycompressormk_2");
	}
	...
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction,
			...
			if (entity instanceof EntityPlayer) {
				((EntityPlayer) entity).openGui(HydrexiumMod.instance, GuiCompressormk2craft.GUIID, world, x, y, z);
			}
			return true;
		}
	}
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return "container.compressormk_2";
		}
		...
		public String getGuiID() {
			return "hydrexium:compressormk_2";
		}

		@Override
		public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
			return new GuiCompressormk2craft.GuiContainerMod(this.getWorld(), this.getPos().getX(), this.getPos().getY(), this.getPos().getZ(),
					playerIn);
		}
