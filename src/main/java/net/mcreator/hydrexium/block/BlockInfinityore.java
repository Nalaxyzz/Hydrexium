...
public class BlockInfinityore extends ElementsHydrexiumMod.ModElement {
	@GameRegistry.ObjectHolder("hydrexium:infinityore")
	public static final Block block = null;
	public BlockInfinityore(ElementsHydrexiumMod instance) {
		super(instance, 6);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("infinityore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("hydrexium:infinityore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("infinityore");
